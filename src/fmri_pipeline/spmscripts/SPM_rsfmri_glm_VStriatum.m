...
function SPM_rsfmri_glm_VStriatum(swurestfile,rprestfile,wc2file,wc3file)
...
SubjFFX3 = strcat(pwd, fs, 'L_VStriatum');
SubjFFX4 = strcat(pwd, fs, 'R_VStriatum');
SubjFFX5 = strcat(pwd, fs, 'VStiatum');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% signal extraction for Nucleus accumbens %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

matlabbatch{1}.spm.util.voi.spmmat = cellstr(strcat(SubjFFX2, fs, 'SPM.mat'));
matlabbatch{1}.spm.util.voi.adjust = 1;
matlabbatch{1}.spm.util.voi.session = 1;
matlabbatch{1}.spm.util.voi.name = 'L_NAcc';
matlabbatch{1}.spm.util.voi.roi{1}.label.image = cellstr(spm_select('ExtFPList', dir_parcellations, '^rAAL3v1_2_4mm.*\.nii$'));
matlabbatch{1}.spm.util.voi.roi{1}.label.list = 157;
matlabbatch{1}.spm.util.voi.roi{2}.mask.image = cellstr(spm_select('FPList', SubjFFX2, '^mask.*\.nii$'));
matlabbatch{1}.spm.util.voi.expression = 'i1 & i2';

matlabbatch{2} = matlabbatch{1};
matlabbatch{2}.spm.util.voi.name = 'R_NAcc';
matlabbatch{2}.spm.util.voi.roi{1}.label.list = 158;

matlabbatch{3} = matlabbatch{1};
matlabbatch{3}.spm.util.voi.name = 'L_OLF';
matlabbatch{3}.spm.util.voi.roi{1}.label.list = 17;

matlabbatch{4} = matlabbatch{1};
matlabbatch{4}.spm.util.voi.name = 'R_OLF';
matlabbatch{4}.spm.util.voi.roi{1}.label.list = 18;
...
t = load(strcat(SubjFFX2, fs, 'VOI_L_NAcc_1.mat'));
tmp1 = t.Y;
clear t;
t = load(strcat(SubjFFX2, fs, 'VOI_L_OLF_1.mat'));
tmp1(:,2) = t.Y;
clear t;
...
t = load(strcat(SubjFFX2, fs, 'VOI_R_NAcc_1.mat'));
tmp1 = t.Y;
clear t;
t = load(strcat(SubjFFX2, fs, 'VOI_R_OLF_1.mat'));
tmp1(:,2) = t.Y;
clear t;
R = [mean(tmp1,2), tmp2, tmp3, tmp4];
