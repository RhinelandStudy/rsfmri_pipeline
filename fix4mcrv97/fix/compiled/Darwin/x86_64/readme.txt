 ...
 executing the application)
   -to run the shell script, type
    ...
    /mathworks/home/application/v96, run the shell script as:
       ...
       ./run_fix_3_clean.sh /mathworks/home/application/v96
...
-MCRInstaller.zip 
    ...
    Deployment Tool.
-The Macintosh bundle directory structure fix_3_clean.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r fix_3_clean.zip fix_3_clean.app
    or the tar command 
    tar -cvf fix_3_clean.tar fix_3_clean.app
-This readme file 
